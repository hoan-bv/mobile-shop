                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            if(isset($_POST['sbm'])){
                                ...
                                $data = mysqli_query($connect,"SELECT * FROM user WHERE user_mail='$user_mail'");

                                $num_row = mysqli_num_rows($data);
                                if($num_row > 0){
                                    $erro ='<div class="alert alert-danger">Email đã tồn tại!</div>';
                                }
                                else{
                                    $query = mysqli_query($connect,"INSERT INTO user (user_full,user_mail,user_pass,user_level) VALUES ('$user_full','$user_mail','$user_pass','$user_level')");
